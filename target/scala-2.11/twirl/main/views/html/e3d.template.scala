...
class e3d extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
...
Seq[Any](_display_(/*2.2*/main("Startup")/*2.17*/{_display_(Seq[Any](format.raw/*2.18*/("""
    """),format.raw/*3.5*/("""<div class="page-title pt-dark pt-parallax" style="background-image : url("""),_display_(/*3.80*/routes/*3.86*/.Assets.versioned("img/home/header1.jpg")),format.raw/*3.127*/(""" """),format.raw/*3.128*/(""") ;" data-stellar-background-ratio="0.65">
        ...
        <div class="container">
            <div class="inner">
                <div class="title">
                    <h2 class="text-light"><strong>E3D Niger</strong></h2>
                </div>
            ...
            <div class="col-md-9 col-sm-8">
                            ...
                            <div class="panel">
                                ...
                                <div id="ac02" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        <p>Créée en 2014, <strong>E3D Niger</strong> est une jeune entreprise qui intervient dans la vente des produits et matériels phytosanitaires, la valorisation des ressources naturelles à base de Neem.</p>
                                        <p>
                                            Elle accompagne le monde agricole et rural par des conseils,  des sensibilisations, des formations et  des solutions et innovations en matière d'herbicides, d'insecticides, engrais, traitements de semences.                                        </p>

                                    </div>
                                    <div class="embed-responsive embed-responsive-16by9 space-top-2x space-bottom-2x">
                                        <iframe src="https://www.youtube.com/embed/Rv2l9yejgKs" frameborder="0" allowfullscreen class="embed-responsive-item"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-group" id="accordion3">
                            <div class="panel">
                                ...
                                <div id="pb01" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        Ce savon permet de se protéger contre les piqures des insectes aide à lutter contre les ectoparasites (acnés, démangeaison, la gale, les dartres…)
                                    </div>
                                </div>
                            </div>
                            <div class="panel">
                                ...
                                <div id="pb02" class="panel-collapse collapse" role="tabpanel">
                                    <div class="panel-body">
                                        Fait à base d’huile de neem, c’est insecticide est l’idéal pour un traitement phytosanitaire écologique afin de lutter efficacement contre les moustiques, les cafards, les mouches, les araignées….
                                    </div>
                                </div>
                            </div>
                            <div class="panel">
                                ...
                                <div id="pb03" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        Fabriqué à base de tourteau de neem, pour amender les terres dégradées, développé et augmenter la productivité de l’agriculture familiale afin de lutter contre l’insécurité alimentaire.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tile" id="ask-question">
                    <form method="post" autocomplete="off" action="contacts">
                        ...
                        <p class="text-gray text-center"><strong>info@e3dniger.com<br>(227) 96 58 59 57 / 90 58 59 57 / 94 55 59 57</strong> </p>
                        <div class="row">
                            <div class="col-sm-6">
...
/**/
object e3d extends e3d_Scope0.e3d
              /*
                  -- GENERATED --
                  DATE: Mon Apr 25 02:51:24 WAT 2016
                  SOURCE: /home/brabo/Desktop/cipmen/app/views/e3d.scala.html
                  HASH: c469150ecc561ae626607e26877123f13618ecf0
                  MATRIX: 823->2|846->17|884->18|915->23|1016->98|1030->104|1092->145|1121->146
